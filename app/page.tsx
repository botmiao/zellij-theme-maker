...
const PRESETS = {
    "synthwave-84": {
        text_unselected: {
            base: [241, 233, 240],
            background: [36, 27, 47],
            emphasis_0: [249, 42, 173],
            emphasis_1: [114, 241, 184],
            emphasis_2: [190, 150, 210],
            emphasis_3: [249, 126, 114],
        },
        text_selected: {
            base: [114, 241, 184],
            background: [36, 27, 47],
            emphasis_0: [249, 42, 173],
            emphasis_1: [114, 241, 184],
            emphasis_2: [199, 146, 234],
            emphasis_3: [249, 126, 114],
        },
        ribbon_unselected: {
            base: [190, 185, 215],
            background: [65, 45, 85],
            emphasis_0: [220, 95, 165],
            emphasis_1: [85, 205, 215],
            emphasis_2: [180, 140, 230],
            emphasis_3: [240, 160, 90],
        },
        ribbon_selected: {
            base: [30, 20, 40],
            background: [249, 42, 173],
            emphasis_0: [30, 20, 40],
            emphasis_1: [114, 241, 184],
            emphasis_2: [199, 146, 234],
            emphasis_3: [249, 126, 114],
        ...
        multiplayer_user_colors: {
            player_1: [249, 42, 173],
            player_2: [114, 241, 184],
            player_3: [190, 150, 210],
            player_4: [249, 126, 114],
            player_5: [0, 240, 255],
            player_6: [255, 140, 0],
            player_7: [138, 43, 226],
            player_8: [0, 255, 127],
            player_9: [255, 215, 0],
            player_10: [255, 20, 147],
        },
    },
    dracula: {
        text_unselected: {
...
export default function Home() {
    ...
    const readFromClipboard = async () => {
        try {
            ...
            // 将报错写进输入框中提醒用户手动粘贴
            setImportText(
                "Clipboard access denied by browser security policies. Please press Ctrl+V / Cmd+V to paste manually.",
            );
        }
    };
    ...
    return (
        <div className="flex h-screen w-full bg-gray-900 text-gray-200 font-sans">
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm">
                    <div className="bg-gray-800 p-6 rounded-lg shadow-2xl w-full max-w-2xl border border-gray-600 flex flex-col space-y-4">
                        ...
                        <p className="text-xs text-gray-400">
                            Or paste your KDL text manually below:
                        </p>
                        ...
                        <div className="flex justify-between items-center pt-2">
                            ...
                            <div className="flex space-x-2">
                                <button
                                    ...
                                    className="px-4 py-1.5 bg-transparent hover:text-white text-gray-400 rounded text-sm transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={() => processImportedText(importText)}
                                    className="px-4 py-1.5 bg-pink-600 hover:bg-pink-500 text-white rounded font-bold text-sm transition-colors"
                                >
                                    Apply Import
                                </button>
                            </div>
            ...
            <div className="w-1/3 min-w-[320px] max-w-md bg-gray-800 flex flex-col border-r border-gray-700 overflow-hidden relative z-50">
                <div className="p-4 bg-gray-900 border-b border-gray-700 flex flex-col space-y-3">
                    ...
                    <h1
                        ...
                        style={{
                            backgroundImage: `linear-gradient(to right, ${rgbStr(theme.text_selected.emphasis_0)}, ${rgbStr(theme.text_selected.emphasis_1)})`,
                        }}
                    >
                        Zellij Theme Maker
                    </h1>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6">
                    {Object.keys(theme).map((group) => (
                        <div
                            key={group}
                            className="bg-gray-750 rounded p-3 bg-gray-900 shadow-inner"
                        >
            ...
            <div className="flex-1 bg-black p-4 flex items-center justify-center overflow-auto shadow-inner">
                ...
                <div className="w-full min-w-[800px] max-w-6xl aspect-video flex flex-col overflow-hidden font-mono text-sm relative shadow-2xl">
                    ...
                    >
                        <div
                            ...
                            style={{
                                backgroundColor: rgbStr(theme.text_unselected.background),
                                color: rgbStr(theme.text_unselected.base),
                            }}
                        >
                            Zellij (test)
                        </div>
                        ...
                        <div className="flex items-center text-xs ml-auto">
                            <span
                                style={{ color: rgbStr(theme.ribbon_selected.background) }}
                                className="mr-2"
                            >
                                Alt {"<[]>"}
                            </span>
                    ...
                    <div className="flex-1 p-[1px] pt-2 relative z-0 flex flex-col min-h-0">
                        <div
                            className="flex-1 border relative"
                            style={
                                theme.frame_unselected
                                    ? { borderColor: rgbStr(theme.frame_unselected.base) }
                                    : undefined
                            }
                        >
                            <div
                                className="absolute top-0 left-2 -translate-y-1/2 px-1 text-xs whitespace-nowrap"
                                style={{
                                    backgroundColor: rgbStr(theme.text_selected.background),
                                    ...(theme.frame_unselected
                                        ? { color: rgbStr(theme.frame_unselected.base) }
                                        : {}),
                                }}
                            >
                                theme-makaer@zellij:~
                            ...
                            <div className="p-3 flex items-center space-x-2 whitespace-nowrap">
                                ...
                                <span
                                    style={{ color: rgbStr(theme.text_selected.emphasis_1) }}
                                    className="font-bold"
                                >
                                    ❯
                                </span>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-30">
                        <div
                            ...
                            style={{
                                borderColor: rgbStr(theme.frame_selected.base),
                            }}
                        >
                            ...
                            <div className="absolute top-0 left-0 w-full flex justify-between items-center px-4 -translate-y-1/2 text-xs whitespace-nowrap">
                                <div className="flex items-center space-x-1">
                                    <span
                                        className="px-1"
                                        style={{
                                            color: rgbStr(theme.frame_selected.base),
                                            backgroundColor: rgbStr(
                                                theme.frame_selected.background,
                                            ),
                                        }}
                                    >
                                        {" "}
                            ...
                            <div
                                className="p-4 pt-4 text-sm flex flex-col space-y-4"
                                style={{ color: rgbStr(theme.text_unselected.base) }}
                            >
                                {/* Breadcrumb row */}
                                <div className="flex items-center text-xs font-bold whitespace-nowrap overflow-hidden">
                                    <span
                                        style={{ color: rgbStr(theme.text_selected.emphasis_3) }}
                                        className="mr-2"
                                    >
                                        {"<TAB>"}
                                    </span>
                                    <div className="flex items-center">
                                        <span
                                            className="flex items-center h-6 z-20 [clip-path:polygon(10px_50%,0_0,calc(100%-10px)_0,100%_50%,calc(100%-10px)_100%,0_100%)] pr-4 pl-4"
                                            style={{
                                                backgroundColor: rgbStr(
                                                    theme.ribbon_unselected.background,
                                                ),
                                                color: rgbStr(theme.ribbon_unselected.base),
                                            }}
                                        >
                                        ...
                                        <span
                                            className="flex items-center h-6 z-10 [clip-path:polygon(10px_50%,0_0,calc(100%-10px)_0,100%_50%,calc(100%-10px)_100%,0_100%)] pr-4 pl-4 -ml-1"
                                            style={{
                                                backgroundColor: rgbStr(
                                                    theme.ribbon_selected.background,
                                                ),
                                                color: rgbStr(theme.ribbon_selected.base),
                                            }}
                                        >
                                ...
                                <div
                                    style={{ color: rgbStr(theme.text_selected.emphasis_2) }}
                                    className="pt-2 whitespace-nowrap"
                                >
                                ...
                                <div
                                    ...
                                    style={{
                                        backgroundColor: rgbStr(theme.list_selected.background),
                                        color: rgbStr(theme.list_selected.base),
                                    }}
                                >
                                    <div style={{ color: rgbStr(theme.list_selected.base) }}>
                                        {"> 1. Default"}
                                    </div>
                                    <div
                                        className="pl-4"
                                        style={{ color: rgbStr(theme.list_selected.base) }}
                                    >
                                        - All modes available directly from the base mode, eg.:
                                    </div>
                                    <div className="pl-4 flex space-x-2">
                                        <span>-</span>
                                        <span
                                            style={{
                                                color: rgbStr(theme.list_selected.emphasis_3),
                                            }}
                                        >
                                            Ctrl p
                                        </span>
                                        ...
                                        <span
                                            style={{
                                                color: rgbStr(theme.list_selected.emphasis_2),
                                            }}
                                        >
                                            PANE
                                        </span>
                                ...
                                <div
                                    ...
                                    style={{ color: rgbStr(theme.list_unselected.base) }}
                                >
                                    <div>{"> 2. Unlock First (non-colliding)"}</div>
                                    <div className="pl-4">
                                        - Single key modes available after unlocking with Ctrl g,
                                        eg.:
                                    </div>
                                    <div className="pl-4 flex space-x-2">
                                        <span>-</span>
                                        <span
                                            style={{
                                                color: rgbStr(theme.list_unselected.emphasis_3),
                                            }}
                                        >
                                            Ctrl g + p
                                        </span>
                                ...
                                <div
                                    className="pt-4 flex items-center space-x-2 text-xs whitespace-nowrap"
                                    style={{ color: rgbStr(theme.list_unselected.base) }}
                                >
                                    <span>Leader keys:</span>
                                    <span
                                        style={{ color: rgbStr(theme.list_unselected.emphasis_3) }}
                                    >
                                        Ctrl
                                    </span>
                                    <span>- modes,</span>
                                    <span
                                        style={{ color: rgbStr(theme.list_unselected.emphasis_0) }}
                                    >
                                        Alt
                                    </span>
                    ...
                    >
                        <div className="flex h-full items-center">
                            ...
                            {[
                                ...
                                <div
                                    key={sc.key}
                                    className="flex items-center h-full shrink-0 [clip-path:polygon(10px_50%,0_0,calc(100%-10px)_0,100%_50%,calc(100%-10px)_100%,0_100%)] pr-4 pl-6 -ml-2"
                                    style={{
                                        color: rgbStr(theme.ribbon_unselected.base),
                                        backgroundColor: rgbStr(theme.ribbon_unselected.background),
                                        zIndex: 40 - index,
                                ...
                                >
                                    ...
                                    <span
                                        style={{
                                            color: rgbStr(theme.ribbon_unselected.emphasis_0),
                                        }}
                                    >
                                        {sc.key}
                                    </span>
                        ...
                        <div className="flex h-full items-center shrink-0">
                            <span
                                style={{ color: rgbStr(theme.text_selected.emphasis_0) }}
                                className="mr-2 z-30 font-bold"
                            >
                                Alt +
                            </span>
                            <div
                            ...
                            >
                                <span>{"<"}</span>
                                <span style={{ color: rgbStr(theme.ribbon_unselected.emphasis_0) }}>
                                    n
                                </span>
                                <span>{">"}</span>
                            ...
                            >
                                <span>{"<"}</span>
                                <span style={{ color: rgbStr(theme.ribbon_selected.emphasis_0) }}>
                                    f
                                </span>
                                <span>{">"}</span>
